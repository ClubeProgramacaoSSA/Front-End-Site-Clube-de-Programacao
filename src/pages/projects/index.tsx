  ...
  return (
    ...
    <div className='text-white max-w-4xl mx-auto my-20 flex flex-col items-center'>
      ...
      <p className='text-center font-Manrope mx-6 text-lg'>
        ...
        <a className='text-orange font-bold' target="_blank" rel="noopener noreferrer" href="https://github.com/ClubeProgramacaoSSA"> GitHub, </a> e podem ser acessados
        pelos links abaixo. Outras documentações ou vídeos podem ser acessadas pelo <a className='text-orange font-bold' target="_blank"
